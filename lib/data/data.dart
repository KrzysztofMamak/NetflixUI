...
final List<Content> mostSearched = const [
  Content(name: 'Violet Evergarden', imageUrl: Assets.violetEvergardenBanner),
  Content(name: 'How to Sell Drugs Online (Fast)', imageUrl: Assets.howToSellDrugsOnlineFastBanner),
  Content(name: 'Kakegurui', imageUrl: Assets.kakeguruiBanner),
  Content(name: 'Carole and Tuesday', imageUrl: Assets.caroleAndTuesdayBanner),
  Content(name: 'Black Mirror', imageUrl: Assets.blackMirrorBanner),
  Content(name: 'Explained', imageUrl: Assets.explainedBanner),
  Content(name: 'Avatar The Last Airbender', imageUrl: Assets.avatarTheLastAirbenderBanner),
  Content(name: 'Tiger King', imageUrl: Assets.tigerKingBanner),
  Content(name: 'The Crown', imageUrl: Assets.theCrownBanner),
  Content(name: 'Dogs', imageUrl: Assets.dogs),
  Content(name: 'Stranger Things', imageUrl: Assets.strangerThingsBanner),
  Content(name: 'The Witcher', imageUrl: Assets.theWitcherBanner),
  Content(name: 'The Umbrella Academy', imageUrl: Assets.umbrellaAcademyBanner),
  Content(name: '13 Reasons Why', imageUrl: Assets.thirteenReasonsWhyBanner),
  Content(name: 'The End of the F***ing World', imageUrl: Assets.theEndOfTheFuckingWorldBanner),
];

final List<Content> searchable = const [
  Content(name: 'Violet Evergarden', imageUrl: Assets.violetEvergarden),
  Content(name: 'How to Sell Drugs Online (Fast)', imageUrl: Assets.htsdof),
  Content(name: 'Kakegurui', imageUrl: Assets.kakegurui),
  Content(name: 'Carole and Tuesday', imageUrl: Assets.caroleAndTuesday),
